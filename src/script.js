...
createCube = (params) => {
	return `<div class="cube ${params.className}" style="width: ${
		params.blockX
	}px;height: ${params.blockY}px;left: ${params.blockLeft}px;bottom: -${
		params.blockX
	}px;transform: translateZ(${params.transformZ}px)">
            <div class="side top" style="transform: rotateX(90deg) translateZ(${
													params.blockY / 2
												}px);width: ${params.blockX}px;height: ${params.blockY}px;"></div>
            <div class="side front" style="transform: translateZ(${
													params.blockY / 2
												}px);height: ${params.blockZ}px;"></div>
            <div class="side back" style="transform: translateZ(${
													-params.blockY / 2
												}px);height: ${params.blockZ}px;"></div>
            <div class="side left" style="transform: rotateY(90deg) translateZ(${
													-params.blockY / 2 + params.blockX
												}px);width: ${params.blockY}px;height: ${params.blockZ}px;"></div>
